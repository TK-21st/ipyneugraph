...
# -*- coding: utf-8 -*-
#
# ipyneugraph documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipyneugraph', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipyneugraphdoc'
...
latex_documents = [
    (master_doc, 'ipyneugraph.tex', 'ipyneugraph Documentation',
     'Tingkai liu', 'manual'),
]
